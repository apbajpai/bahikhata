            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Edit vehicle model</h1>                            </div>

                        <div class="float-right ">
                            <ol class="breadcrumb">
                                
                                <li>
                                    <a href="<?=base_url();?>index.php/Vehicle_Model">Vehicle (Model)</a>
                                </li>
                ...
                <div class="clearfix"></div>
                                ...
                                <?php echo form_open_multipart('vehicle_model/do_update_data');?>
                                 <?php                                          
                                         if (isset($val)) {
                                              $cust_get_val = $this->db->where('id', $val);
                                              $cust_get_val = $this->db->get("model");                                              
                                          ...
                                          //echo strcasecmp($this->router->class,"vehicle_model");die();
                        ...
                        <div class="content-body">
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="field-1">Model Code</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" value="<?=$cust_val->code;?>" class="form-control" id="field-1" name="code"  placeholder="Model Code" required autofocus>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="field-1">Model Title</label>
                                            <span class="desc"></span>
                                            <div class="controls">
                                                <input type="text" value="<?=$cust_val->title;?>" class="form-control" id="field-2"  placeholder="Model Title" name="title" required>
                                            </div>
                                        </div>
