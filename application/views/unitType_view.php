            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    <div class="float-left">
                        <h1 class="title">Unit Type Details</h1>    </div>
                        <div class="float-right ">
                            <ol class="breadcrumb">
                                <li>
                                    <a href="<?=base_url("index.php/Settings/unitType_add");?>" > <i class="fa fa-edit"></i>Add New Unit Type</a>                                   
                                </li>
                            </ol>
                        </div>
                        <div class="float-right d-none">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="crm-customers.html">Unit Type Details</a>
                                </li>
                                <li class="active">
                                    <strong>Unit Type Details(All)</strong>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <section class="box ">
                        <header class="panel_header">
                            <h2 class="title float-left">Unit Type Details</h2>
                        </header>
                        <div class="content-body">    <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>SNo.</th><th> Unit Type</th><th>Status</th> <th>Edit</th> </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                            $i=0;
                                            foreach ($unitTypes as $unitType)
                                                {    $i++; 
                                                    ?>
                                                    <tr>
                                                        <td><?=$i;?></td><td><?=$unitType->tittle;?> </td>
                                                        <td><a href="#" class="active_status" id="<?=$unitType->id;?>"><? if ($unitType->active_status) { echo $unitType->active_status;}else{echo "Inactive";}?></a> </td>
                                                        <td><a href="<?=base_url();?>/Settings/unitType_add/<?=$unitType->id;?>"><i class="fa fa-edit"></i></a></td>
                                                    </tr>
                                                <? }
                                                ?> 
                                            </tbody>
                ...
                <script >
                    $(document).ready(function() {
                        ...
                        $(".active_status").click(function(){
                            $.ajax({
                                type: "POST",
                                url: "<?=base_url();?>/settings/unitType_status",
                                data: { 
                                    keyword: this.id
                                },
                                dataType: "json",
                                success: function (data) { 
                                    window.location.replace("<?=base_url();?>/settings/unitType/");
                                }
                            });
                        });
                    } );</script>
