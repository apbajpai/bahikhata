                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-11" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                       <?php  
                                       		$cust_data = $this->db->order_by('make_id', 'ASC', 'title', 'ASC');
									         $cust_data = $this->db->get("model");
									        $i=0; 
                                            ...
                                            {  $i++;?>
                                              <tr>
                                                  ...
                                                  <td> (Make) : <?=$this->db->get_where('make', array('id' => $vehicle_details->make_id, ))->row()->title;?> ---(Model)--- <?=$vehicle_details->title;?></td>                                                  
                                                  <td><a href="<?=base_url();?>index.php/vehicle_model/edit_val/<?=$vehicle_details->id;?>">
