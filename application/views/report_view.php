                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       <?php             
                                            ...
                                            {  $i++; 
                                               if ($page_name =='purchase' || $page_name == 'sales' || $page_name == 'gensales') {$customer_details->amount = $customer_details->grand_total;}
                                               if ($page_name =='purchase' || $page_name == 'sales' || $page_name == 'gensales') {$customer_details->particulars = $customer_details->note;$customer_details->bill_date=$customer_details->bil_date;}
                                               if ($page_name =='purchase') {$customer_details->payment_option = "Purchases"; $customer_details->party_code=$customer_details->bill_no;}
