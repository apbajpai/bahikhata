        ...
        <section class="wrapper main-wrapper" style=''>
            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                ...
                <div class="clearfix"></div>
                 <?php echo form_open('Accounts/do_update_master/Sales', 'name="form1" onSubmit="return ValidateData(this);"' );?>
                        ...
                        <div class="content-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                 ...
                                 <div class="form-group col-md-4">
                                    <label class="form-label" for="field-2">Entry Date<b><img src="<?=base_url();?>assets/assets/images/st.gif" alt=""></b></label>
                                    ...
                                    <div class="form-row">
                                     <div class="form-group col-md-4">
                                        <label class="form-label" for="field-2">Item Name<b>
                                            <img src="<?=base_url();?>assets/assets/images/st.gif" alt=""></b></label>
                                        <span class="desc"></span>
                                        <div class="controls">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            ...
                            <div class="text-left">
                                        ...
                                        <input type="hidden" value="Sales" id="type"  name="type" />
...
//});
 ...
 //            });
   ...
   function cal_grand_total()
   {
    $dom.ajax({
            type: "POST",
            url: "<?=base_url();?>index.php/Testpages/cal_grand_total",
            data: { 
                mode: "add",
