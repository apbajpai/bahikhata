            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Add a AccountHead Name </h1> 
                    </div>
                     <div class="float-right ">
                            <ol class="breadcrumb">
                                
                                <li>
                                    <a href="<?=base_url();?>index.php/Settings/accounthead">AccountHead View</a>
                                </li>
                ...
                <div class="clearfix"></div>
                 <?php echo form_open_multipart('Settings/accounthead_update');?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="field-1">AccountHead Name</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" value="<?=$accounthead_details->tittle;?>" class="form-control" id="field-1" name="tittle" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" value="<?=$accounthead_details->type;?>" class="form-control" id="field-3" name="type" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12 padding-bottom-30">
                                    <div class="text-left">
                                        ...
                                        <input type="hidden" class="form-control"  value="<?=$accounthead_details->active_status;?>" id="field-51" name="active_status">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" value="" class="form-control" id="field-3" name="type" required>
                                        </div>
                                    </div>
