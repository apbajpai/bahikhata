      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-12 invoice-col">
          <address>
            ...
            <span class="pull-left"><b><?=$type;?> Invoice #:</b> <strong><?=$sales_deatils->bill_no;?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
            <span class="pull-right"><b>Billing Date :</b> <?=$sales_deatils->bil_date;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br/>
            <span class="pull-left"><b>Name:</b>    <strong><?=$sales_deatils->party_name;?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <span class="pull-right"><b>Address:</b>  <?=$sales_deatils->party_add;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br/>
            <span class="pull-left"><b>Phone:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <?=$sales_deatils->party_phone;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Mobile:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <?=$sales_deatils->party_mobile;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <? if(strcasecmp($type,'sales' )==0){?><b>PAN/TIN/VAT/GST:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <?=$sales_deatils->pan_no;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? }?>
          </span>

            <br/>

            <? if(strcasecmp($type,'purchase' )==0){?>
            <span class="pull-left"><b>Supplier Invoice No.:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <?=($sales_deatils->sup_no);?></span>
            <span class="pull-right"><b>Supplier Invoice Date:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <?=$sales_deatils->sup_dt;?> </span><br/>
            <span class="pull-left"><b>Supplier PAN:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <?=$sales_deatils->sup_pan;?></span>
            <span class="pull-right"><b>Supplier TIN/VAT/GST:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <?=$sales_deatils->sup_tin;?></span>
            <? }?>
          </address>
        </div>
  ...
  <!-- info row -->
      <div class="row">
        <div class="col-12 ">
         ...
         <span class="pull-right"> Discount In &#x20B9; :&nbsp; <strong style="color:red;"><?php echo ($sales_deatils->final_discount);?></strong></span>
        </div>
        <!-- /.col -->
      </div>
      <!-- info row -->
      ...
      <div class="row">
        <div class="col-12 ">
         ...
         <span class="pull-right"> Grand Total :&nbsp; <strong style="color:red;"><?php echo ($sales_deatils->grand_total);?></strong></span>
        </div>
        <!-- /.col -->
      </div>
      <!-- info row -->
...
<? if(strcasecmp($type,'purchase' )==0){?>
 <div class="row">
      <div class="col-12 ">
        ...
        For
            <address>
              <strong><?=$sales_deatils->party_name;?></strong><br><br>
