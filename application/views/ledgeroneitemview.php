            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Item Wise Ledger </h1> 
                    </div>
                </div>
            </div>
                <div class="clearfix"></div>
                 <?php echo form_open_multipart('Accounts/ledger_oneitem', 'name="form1"');?>
                                <!-- <form action ="customeradd" method="post" > -->
                <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                    <section class="box ">
                        <header class="panel_header">
                            <h2 class="title float-left">Search by Registration</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="field-1">Rgistration Number</label>
                                        ...
                                        <div class="controls">
                                            ...
                                            <select name="item_name" required class="form-control">
                                             ...
                                             <option value="">---Select---</option>
                                               ...
                                               foreach ($itemdetails as $key => $items) 
                                                    { if(!empty($items->item)){?>
