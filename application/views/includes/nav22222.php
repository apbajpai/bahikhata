...
<div class="page-container row-fluid">
    ...
    <div class="page-sidebar ">
        ...
        <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
            ...
            <li class="<? 
            if( strcasecmp($this->router->class,"Vehicle_make")==0 && $this->router->method == 'add_new' ){ ?> open<? }elseif( strcasecmp($this->router->class,"Vehicle_make")==0 &&  $this->router->method == 'edit_val'){ ?> open<? }elseif( strcasecmp($this->router->class,"Vehicle_make")==0 ){ ?> open<? }?>"> 
                <a href="javascript:;">
                    <i class="fa fa-question-circle"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a class="<? if(strcasecmp($this->router->class,"Vehicle_make")==0 && $this->router->method=='add_new'){ echo "active";}?>" href="<?=base_url("index.php/Vehicle_Make/add_new");?>" >Add New Vehicle Make</a>
                    </li>

                </ul>
            </li>
            <li class="<? if( strcasecmp($this->router->class,"vehicle_model")==0 && $this->router->method == 'add_new'){ echo "open"; }elseif( strcasecmp($this->router->class,"vehicle_model")==0 &&  $this->router->method == 'edit_val'){ echo "open";}elseif( strcasecmp($this->router->class,"vehicle_model")==0 ){ echo "open";}?>"> 
                <a href="javascript:;">
                    <i class="fa fa-question-circle"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a class="<? if( strcasecmp($this->router->class,"vehicle_model")==0 && $this->router->method=='add_new' ){ echo "active";}elseif( strcasecmp($this->router->class,"vehicle_model")==0 &&  $this->router->method=='edit_val'){ echo "active";}?>" href="<?=base_url("index.php/Vehicle_Model/add_new");?>" >Add New Vehicle Model</a>
                    </li>
            ...
            <li class="<? if(strcasecmp($this->router->class,"accounts")==0 ){ ?> open<? }?>"> 
                <a href="javascript:;">
                    <i class="fa fa-users"></i>
                ...
                <ul class="sub-menu" >
                    ...
                    <li>
                        <a class="<? if(strcasecmp($this->router->class,"accounts")==0 && strcasecmp($this->router->method,"ledger_all")==0){ ?> active<? }?>" href="<?=base_url("index.php/Accounts/ledger_all");?>" >Ledger All</a>
                    </li>
                     <li>
                        <a class="<? if(strcasecmp($this->router->class,"accounts")==0 && strcasecmp($this->router->method,"ledgerone")==0){ ?> active<? }?>" href="<?=base_url("index.php/Accounts/ledgerone");?>" >Ledger One</a>
                    </li>

                </ul>
            </li>
            <li class="<? if(strcasecmp($this->router->class,"Settings")==0 ){ ?> open<? }?>"> 
                <a href="javascript:;">
                    <i class="fa fa-users"></i>
            ...
            <li class="<? if(strcasecmp($this->router->class,"userprofile")==0 ){ ?> open<? }?>"> 
                <a href="javascript:;">
