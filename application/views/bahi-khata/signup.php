    ...
    <div class="login-wrapper">
        <div id="login" class="login loginpage col-sm-8">
            ...
            if ($this->session->userdata('sess_mess')) {
                echo "<span class='alert alert-success'>".$this->session->userdata('sess_mess')."</span>";$this->session->unset_userdata('sess_mess');
            } else {
                echo "<span class='alert alert-danger'>"."Please Fill All Details..........."."</span>";
            }
            ?>  
            </center>          
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6 forgetmenot">
                                        ...
                                        <div class="col-md-6 submit">
                                            <button class="g-recaptcha btn btn-orange btn-block" data-sitekey="6Lf9UJMdAAAAAEYN9nX6niPFR6Ze8vDMm2yhhFYK" data-callback='onSubmit' data-action='submit' id="wp-submit" type="submit" name="wp-submit">Sign Up</button>
                                        </div>
                                    </div>
                                </form>
                                <p id="nav">
