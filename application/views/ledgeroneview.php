            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Ledger One </h1> 
                    </div>
                </div>
            </div>
                <div class="clearfix"></div>
                 <?php echo form_open_multipart('Accounts/ledger_one', 'name="form1"');?>
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select name="party_name" required class="form-control">

                                             <option value="">---Select---</option>
                                                <?php
                                                 
                                               foreach ($customerdetails as $key => $customer) 
                                                    { if(!empty($customer->party_name)){?>
                                                   <option  value="<?=$customer->party_name;?>"><?=$customer->party_name;?></option>
                                                   <?php
                                                    } }?>
                                                </select>
