                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="<? if(isset($ledgerone_uname)){echo "example";}else{ echo $uname;}?>" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th><th>Name</th><th>date</th><th>type</th><th style="text-align:right;">dr</th><th style="text-align:right;">cr</th><th style="text-align:right;">Balance</th>      </tr>
                                            </thead>
                                       ...
                                       <?php             
                                            ...
                                            {  $i++; 
                                                ...
                                                ?>
                                              <tr>
                                                  <td><?=$i;?></td><td><?=$customer_details->party_name;?> </td><td><?=$customer_details->dat;?></td><td><?=$customer_details->type;?></td><td style="text-align:right;"><?=$customer_details->dr;?></td><td style="text-align:right;"><?=$customer_details->cr;?> </td> <td style="color:<? if($balance>0) echo "red";else echo "blue";?>; text-align:right;"><?=$bal;?> </td>
                                              </tr>
                                              <? }
