                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="<? if($this->uri->segment('3')){echo "example";}else{ echo $uname;}?>" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr> <th>Date</th><th>Party Name</th><th>Bill No</th><th>Particulars</th><th>Type</th><th style="text-align:right;">Debit</th><th style="text-align:right;">Credit</th><th style="text-align:right;">Balance</th><th style="text-align:right;">DR/CR</th><th style="text-align:center;">Action</th><th style="text-align:center;">View</th></tr>
                                            </thead>
                                       ...
                                       <?php             
                                            ...
                                            {  $i++; 
                                                if ($page_name == 'purchase') {$customer_details->amount = $customer_details->grand_total;}
                                                if ($page_name == 'purchase') {$customer_details->particulars = $customer_details->note;}
                                                ...
                                                ?>
                                              <tr>
                                                  <td><?=$i;?></td><td><?=$customer_details->party_name;?> </td><td> Bill No. <?=$customer_details->party_code;?> </td><td><?=$customer_details->particulars;?></td><td><?=$customer_details->payment_option;?></td><td style="text-align:right;"><?=$customer_details->amount;?></td><td style="text-align:center;"> - </td> <td style="color:<? if($balance>0) echo "red";else echo "blue";?>; text-align:right;"><?=number_format($balance,2);?> </td> <td style="text-align:right;"><?=$bal;?> </td> 
